...
import { UserRole } from '../auth/user.entity';
  ...
  export class DocumentsController {
    ...
    uploadDocument( @UploadedFile() file: Express.Multer.File, @Body() createDocumentDto: CreateDocumentDto): Promise<Document> {
    ...
    @Patch(':id')
    @Roles(UserRole.Editor, UserRole.Admin)
    updateDocuemnt(@Param('id') id: string, @Body() updateDocumentDto: UpdateDocumentDto):Promise<Document> {
